...
export type CreatorRow = {
  ...
  tiktok_avg_engagement_rate: number | null;
  tiktok_engagement_rate_30d: number | null;
  tiktok_likes_30d: number | null;
  tiktok_comments_30d: number | null;
  tiktok_shares_30d: number | null;
  tiktok_views_30d: number | null;
  tiktok_stats_last_updated: string | null;
};
